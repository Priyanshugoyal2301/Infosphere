      ...
      <div className="max-w-2xl mx-auto">
        <div className="card text-center">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
            <h3 className="font-semibold text-secondary-900 mb-3">Issue Details</h3>
            <div className="space-y-2 text-left">
              <div><strong>ID:</strong> #{issue.id}</div>
              <div><strong>Title:</strong> {issue.title}</div>
              <div><strong>Category:</strong> <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded text-sm">{issue.category}</span></div>
              <div><strong>Urgency:</strong> <span className={`px-2 py-1 rounded text-sm ${
                issue.urgency === 'high' ? 'bg-red-100 text-red-800' :
                issue.urgency === 'medium' ? 'bg-yellow-100 text-yellow-800' :
                'bg-green-100 text-green-800'
              }`}>{issue.urgency}</span></div>
              <div><strong>Status:</strong> <span className="px-2 py-1 bg-gray-100 text-gray-800 rounded text-sm">{issue.status}</span></div>
    ...
    <div className="min-h-screen newspaper-bg">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="newspaper-section">
          <h2 className="newspaper-section-title text-2xl font-black text-black border-b-2 border-black pb-2 mb-6 uppercase tracking-wide text-center">
            Report News Story
          </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h3 className="font-medium text-blue-900 mb-2">🤖 AI-Powered Processing</h3>
        ...
        <div className="mt-6 p-4 border border-secondary-200 rounded-lg bg-secondary-50">
          <div className="flex items-center justify-between">
            <div className="text-sm text-secondary-700">Local submissions on this device: <strong>{localCount}</strong></div>
        ...
        <div className="mt-8 pt-6 border-t border-secondary-200">
          <h3 className="font-medium text-secondary-900 mb-3">Common Issue Categories</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-3 bg-blue-50 rounded-lg">
              <div className="text-2xl mb-1">💧</div>
              <div className="text-sm font-medium text-blue-900">Water</div>
              <div className="text-xs text-blue-600">Pipes, leaks, quality</div>
            </div>
            <div className="text-center p-3 bg-gray-50 rounded-lg">
              <div className="text-2xl mb-1">🛣️</div>
              <div className="text-sm font-medium text-gray-900">Road</div>
              <div className="text-xs text-gray-600">Potholes, signals, lighting</div>
            </div>
            <div className="text-center p-3 bg-green-50 rounded-lg">
              <div className="text-2xl mb-1">🗑️</div>
              <div className="text-sm font-medium text-green-900">Garbage</div>
              <div className="text-xs text-green-600">Collection, disposal</div>
            </div>
            <div className="text-center p-3 bg-red-50 rounded-lg">
              <div className="text-2xl mb-1">🔒</div>
              <div className="text-sm font-medium text-red-900">Security</div>
              <div className="text-xs text-red-600">Safety, crime, patrol</div>
            </div>
          </div>
        </div>
      </div>
